     ...
     */
     public static IPersistenciaAerolinea getPersistenciaAerolinea(String tipoArchivo) throws TipoInvalidoException {
        if ("JSON".equalsIgnoreCase(tipoArchivo)) {
            // Return an instance of a class that implements IPersistenciaAerolinea for JSON.
            return new PersistenciaAerolineaJSON();
        } else if ("XML".equalsIgnoreCase(tipoArchivo)) {
            // Return an instance of a class that implements IPersistenciaAerolinea for XML.
            return new PersistenciaAerolineaXML();
        } else {
